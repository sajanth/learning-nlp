# A Hands-On Introduction to Language Modelling

In this repo we are going to dive into the basics of language modeling! If you are looking for the latest and greatest in AI, you have to look somewhere else though - here we will focus on fundamental concepts of statistical modeling and try to derive as much as possible from first principles :) In return, it should be easy to follow even without any background in neural networks!
...
Note: The general idea and flow of this notebook is heavily adapted from Karpathy's excellent [video series](https://www.youtube.com/watch?v=PaCmpygFfXo&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ&index=2) on language modelling. 

Let's get started!

## Overview
* [Data](#first-bullet)
* [Exact modelling - Count count count!](#second-bullet)
* [Quantifying models](#third-bullet)
